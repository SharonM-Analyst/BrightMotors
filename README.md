...
- Computed numeric range statistics (`MIN`, `MAX`, `AVG`) to detect outliers
...
Built a executive Power BI dashboard with dynamic slicers (Date, Location, Manufacturer, Body Design, Transmission, Color):
